...
OPNSENSE_URL   = _req('OPNSENSE_URL',  'https://REDACTED_IP_OPNSENSE')
OPNSENSE_USER  = _req('OPNSENSE_USER', 'root')
OPNSENSE_PASS  = _req('OPNSENSE_PASS', 'opnsense')
SERVER_UUID    = _req('SERVER_UUID',   'REDACTED_SERVER_UUID')
SERVER_PUBKEY  = _req('SERVER_PUBKEY', 'REDACTED_SERVER_PUBKEY')
WG_ENDPOINT    = _req('WG_ENDPOINT',  'REDACTED_IP_PUBLICA:8822')
