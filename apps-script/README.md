...
3. Crea los siguientes archivos (**+ Nuevo archivo → Script**) y pega el contenido:
...
4. **Importante:** antes de guardar, rellena `Config.gs → INFRA_HTML`
   con las instrucciones de tu infraestructura
   (ver `../instrucciones/infraestructura.md`)
